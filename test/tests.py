...
tests = [ {'description': 'PINA 0x01, PINA 0x02 => PORTC = 0x00.',
    ...
    'steps': [ {'inputs': [('PINA', 0x01)],'iterations': 1},
        {'inputs': [('PINA', 0x01)], 'iterations': 1}# Set PIN to val then run one iteratio
     ],
    'expected': [('PORTC',0x02)],
    },
    {'description': 'PINA 0x02 => PORTC = 0x00.',
    'steps': [ {'inputs': [('PINA', 0x02)],'iterations': 1},
        {'inputs': [('PINA', 0x02)], 'iterations': 1}# Set PIN to val then run one iteratio
     ],
    'expected': [('PORTC',0x00)],
    },
    {'description': 'PINA 0x01 => PORTC = 0x01.',
